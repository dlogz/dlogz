    ...
    return (
        <Card>
            ...
            <CardContent className="flex flex-col gap-2 items-start">
                <h2 className="text-lg font-bold mt-2">{blog?.blobId}</h2>
                <p className="text-sm text-gray-500">{blog?.blobHash}</p>
                <span className={`mt-3 badge ${blog?.isPublished ? 'bg-green-500' : 'bg-yellow-500'} text-white rounded-lg px-2 py-1`}>
